 ...
 * 미확정 Q-09 — 배점표는 0·2·4·6칸만 정의한다. 홀수(1·3·5칸)는 하위 짝수로 내림해 조회한다
 * (1→5, 3→7, 5→8). 선형보간으로 확정되면 이 상수와 호출부 내림 규칙을 함께 바꾼다.
 */
export const MOCK_FILL_POINTS = { 0: 5, 2: 7, 4: 8, 6: 10 };
 ...
 * COPY_FALLBACK(TODO(Q-29) 사유 포함)의 정의처는 src/data/diagnosisCopy.js 하나다.
