...
type CutRow = {
  ...
  variant_seq: number | null;
};

type AdmissionCutsQuery = {
  universityKey: string;
  departmentKey: string;
  mainTrack: string;
  admissionTrack: string;
  subjectReflection?: string | null;
};

type AdmissionCutsResult = {
  cut50: number | null;
  cut70: number | null;
 ...
 */
function pickLatestCutRow(rows: CutRow[] | null | undefined): CutRow | null {
