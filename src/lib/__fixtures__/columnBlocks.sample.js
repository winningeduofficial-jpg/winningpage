...
export const columnBlocksSample = {
  ...
  blocks: [
    ...
    },
    {
      ...
      content: [
        { type: "text", text: "제목 (큰) — 밴드(풀폭 배경)", styles: {} },
      ],
      children: [],
    },
    {
    ...
    },
    {
      ...
      content: {
        ...
        rows: [
          ...
          {
            cells: [
              [{ type: "text", text: "값1", styles: {} }],
              [{ type: "text", text: "값2", styles: {} }],
            ],
          },
        ],
      },
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          text: "표(table)는 미지원 타입이라 위에서 문단 폴백으로 렌더된다.",
          styles: {},
        },
      ],
      children: [],
