    ...
    <GoalCard tone="neutral" className="flex min-h-[19.4375rem] flex-col gap-4 px-[1.875rem] py-[1.875rem]">
      <div className="flex items-start justify-between gap-3">
        <div className="flex flex-col gap-1.5">
          <h3 className="text-[1.125rem] font-bold leading-[1.4] text-ink-strong">{name}</h3>
          <span className="text-[0.8125rem] leading-[1.4] text-ink-sub">{zoneLabel}</span>
        </div>
      ...
      <div className="flex flex-col gap-2">
        <p className="text-[0.75rem] font-semibold leading-[1.4] text-ink-sub">공부 방향</p>
