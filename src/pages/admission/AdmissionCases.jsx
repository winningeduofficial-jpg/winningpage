...
import { CASE_CATEGORIES, CATEGORY_LABELS, fetchAdmissionCases } from './admissionCaseData';
...
export default function AdmissionCases() {
  ...
  const category = CASE_CATEGORIES.find((key) => pathname.startsWith(`/admission/${key}`)) || 'susi';
