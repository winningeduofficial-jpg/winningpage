...
export const GRADE_SYSTEM_INPUT_RULES = {
  NINE: { code: 'NINE', min: 1, max: 9, decimals: 2, pattern: /^\d(\.\d{0,2})?$/ },
  FIVE: { code: 'FIVE', min: 1, max: 5, decimals: 2, pattern: /^[1-5](\.\d{0,2})?$/ },
  MIDDLE_AVG: { code: 'MIDDLE_AVG', min: 0, max: 100, decimals: 1, pattern: /^\d{0,3}(\.\d)?$/ },
  UNKNOWN: { code: 'UNKNOWN', min: 1, max: 9, decimals: 2, pattern: /^\d(\.\d{0,2})?$/ }
};
...
export const renewalSurveyQuestions = [
  ...
  },
  {
    ...
    optionCodes: ['GENERAL', 'AUTONOMOUS', 'SPECIAL', 'VOCATIONAL', 'ETC', 'NONE'],
    extra: {}
  },
  {
    id: 'q3',
    ...
    optionCodes: ['BOTH', 'UNIV_ONLY', 'MAJOR_ONLY', 'TIER_ONLY', 'UNDECIDED_MULTI', 'NONE'],
    extra: {}
  },
  {
  ...
  },
  {
    ...
    optionCodes: ['APTITUDE', 'JOB', 'REPUTATION', 'SCORE_FIT', 'PARENT', 'LOCATION', 'UNKNOWN'],
    extra: {
      embeddedIn: 'q3',
      dependsOn: { questionId: 'q3' }
    }
    ...
    extra: {
      ...
      groups: [
        ...
        },
        {
          ...
          fields: [
            { key: 'recent_exam_avg', label: '전체 평균 등급', scale: 'NAESIN', placeholder: '3.00' }
          ]
        },
        {
          key: 'mock_exam',
          ...
          hiddenWhenGradeSystem: ['MIDDLE_AVG'],
          fields: [
            { key: 'mock_korean', label: '국어 등급', scale: 'MOCK', placeholder: '1~9' },
            { key: 'mock_math', label: '수학', scale: 'MOCK', placeholder: '1~9' },
            { key: 'mock_english', label: '영어', scale: 'MOCK', placeholder: '1~9' },
            { key: 'mock_social', label: '사회', scale: 'MOCK', placeholder: '1~9' },
            { key: 'mock_science', label: '과학', scale: 'MOCK', placeholder: '1~9' },
            { key: 'mock_korean_history', label: '한국사', scale: 'MOCK', placeholder: '1~9' }
          ]
        }
      ]
    }
  },
  {
    ...
    optionCodes: ['UP_MOST', 'UP_PART', 'FLAT', 'DOWN_PART', 'VOLATILE', 'NO_DATA'],
    extra: {}
  },
  {
    id: 'q8-followup',
  ...
  },
  {
    ...
    extra: {
      ...
      statements: [
        ...
        { key: 'LK1_02', text: '목표를 위해 어떤 과목과 단원을 먼저 공부해야 하는지 알고 있다' },
        { key: 'LK1_03', text: '해야 할 공부를 주간 또는 일간 단위의 구체적인 분량으로 나누고 있다' },
        { key: 'LK1_04', text: '시험, 수행평가, 학교 일정까지 고려해 계획을 조정하고 있다' },
        { key: 'LK1_05', text: '세운 계획의 70% 이상을 실제로 완료하는 편이다' },
        { key: 'LK1_06', text: '해야 할 공부를 미루지 않고 정해진 시간에 시작하는 편이다' },
        { key: 'LK1_07', text: '평일과 주말에 일정한 공부 시간을 확보하고 있다' },
        { key: 'LK1_08', text: '취약 과목과 중요한 과목에 시간을 우선 배분하고 있다' },
        { key: 'LK1_09', text: '틀린 문제의 원인을 구분해 다시 확인하고 있다' },
        { key: 'LK1_10', text: '시험 결과를 보고 공부 방법이나 계획을 수정한다' },
        { key: 'LK1_11', text: '성적이 기대보다 낮아도 학습 리듬을 비교적 빠르게 회복한다' },
        { key: 'LK1_12', text: '해야 할 일이 많거나 불안할 때도 공부를 시작할 수 있다' }
      ]
    }
  },
  {
  ...
  },
  {
    ...
    extra: {
      ...
      statements: [
        { key: 'LK2_01', text: '과목별 성적과 학습 상태를 비교해 강점과 약점을 알고 있다' },
        { key: 'LK2_02', text: '취약 과목을 보완하기 위한 구체적인 학습 방법이 있다' },
        { key: 'LK2_03', text: '수행평가 안내문에서 평가 기준과 제출 조건을 파악할 수 있다' },
        { key: 'LK2_04', text: '수행평가를 시험 준비와 겹치지 않게 미리 준비하는 편이다' },
        { key: 'LK2_05', text: '교과에서 배운 개념을 탐구 주제로 발전시킬 수 있다' },
        {
          key: 'LK2_06',
          text: '신뢰할 수 있는 자료를 활용해 단순 조사 이상의 분석을 만들 수 있다'
        },
        { key: 'LK2_07', text: '이전에 한 활동을 새로운 탐구로 심화하거나 확장할 수 있다' },
        { key: 'LK2_08', text: '교과 활동과 진로 관심을 자연스럽게 연결할 수 있다' },
        {
          key: 'LK2_09',
        ...
        { key: 'LK2_11', text: '희망 대학과 학과에서 중요하게 보는 요소를 알고 있다' },
        { key: 'LK2_12', text: '현재 성적과 학생부를 기준으로 앞으로 보완할 부분을 알고 있다' }
      ]
    }
  },
  {
  ...
  },
  {
    ...
    optionCodes: ['CONNECTED', 'UNLINKED', 'GRADE_OK', 'INQUIRY_OK', 'AVERAGE', 'UNKNOWN'],
    extra: {}
  },
  {
    id: 'q18',
...
export function getOptionCode(questionId, label) {
  const question = renewalSurveyQuestions.find((item) => item.id === questionId);
