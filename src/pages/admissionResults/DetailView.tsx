...
function ResultTable({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: TODO(useEffectEvent) tableRows/years는 effect 안에서 읽지 않는 트리거 전용 값 — 표 내용이 바뀌어 폭이 달라질 때마다 overflow를 다시 재기 위한 재실행 신호다.
  useEffect(() => {
...
export default function DetailView({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: TODO(useEffectEvent) reloadToken은 effect 안에서 읽지 않는 재조회 트리거 전용 카운터다.
  useEffect(() => {
