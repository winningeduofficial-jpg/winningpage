...
/* PHASE5-WIRE — 배선 완료.
 * PdfDownloadButton.jsx 는 page1/page2 에이전트 스코프 밖이라 생성되지 않았으므로
 * (둘 다 "not created / out of remit" 로 명시), 결정9 스펙을 그대로 인라인 구현한
 * 아래 버튼을 유지한다 — 계약 불일치가 아니라 애초에 미배정 파일.
 */
 ...
 *   main 상단 오프셋은 기존 설문 셸과 동일한 pt-16(4rem, --wn-header-h) 관례를 따른다.
