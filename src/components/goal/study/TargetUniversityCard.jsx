...
function RateRow({ label, value, dotClassName, fillClassName }) {
  return (
    <div className="flex items-center gap-3">
      ...
      <span className="w-[6rem] shrink-0 text-[0.9375rem] leading-[1.4] text-ink">{label}</span>
...
export default function TargetUniversityCard({ label, university, department, susiRate, jeongsiRate }) {
  return (
    <GoalCard tone="neutral" className="flex flex-col gap-8 px-[2rem] py-[1.875rem]">
      <div>
