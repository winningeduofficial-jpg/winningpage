...
// select('*') — 통이미지 카드 22건, Figma 스트립 순서 (sql/20_landing_renewal.sql 시드 순서와 동일)
// mentor_name은 테이블 실컬럼은 아니고 alt 텍스트 폴백용 (MentorSection jsdoc 참고)
// ---------------------------------------------------------------------
export const mentors = [
  { id: 'preview-mentor-01', image_url: '/images/landing/mentors/cards/강지후.png', mentor_name: '강지후', sort_order: 10, is_active: true },
  { id: 'preview-mentor-02', image_url: '/images/landing/mentors/cards/김형준.png', mentor_name: '김형준', sort_order: 20, is_active: true },
  { id: 'preview-mentor-03', image_url: '/images/landing/mentors/cards/박서정.png', mentor_name: '박서정', sort_order: 30, is_active: true },
  { id: 'preview-mentor-04', image_url: '/images/landing/mentors/cards/박찬일.png', mentor_name: '박찬일', sort_order: 40, is_active: true },
  { id: 'preview-mentor-05', image_url: '/images/landing/mentors/cards/이청훈.png', mentor_name: '이청훈', sort_order: 50, is_active: true },
  { id: 'preview-mentor-06', image_url: '/images/landing/mentors/cards/김무경.png', mentor_name: '김무경', sort_order: 60, is_active: true },
  { id: 'preview-mentor-07', image_url: '/images/landing/mentors/cards/하현서.png', mentor_name: '하현서', sort_order: 70, is_active: true },
  { id: 'preview-mentor-08', image_url: '/images/landing/mentors/cards/제민규.png', mentor_name: '제민규', sort_order: 80, is_active: true },
  { id: 'preview-mentor-09', image_url: '/images/landing/mentors/cards/김단아.png', mentor_name: '김단아', sort_order: 90, is_active: true },
  { id: 'preview-mentor-10', image_url: '/images/landing/mentors/cards/김성훈.png', mentor_name: '김성훈', sort_order: 100, is_active: true },
  { id: 'preview-mentor-11', image_url: '/images/landing/mentors/cards/박민정.png', mentor_name: '박민정', sort_order: 110, is_active: true },
  { id: 'preview-mentor-12', image_url: '/images/landing/mentors/cards/김정윤.png', mentor_name: '김정윤', sort_order: 120, is_active: true },
  { id: 'preview-mentor-13', image_url: '/images/landing/mentors/cards/손주연.png', mentor_name: '손주연', sort_order: 130, is_active: true },
  { id: 'preview-mentor-14', image_url: '/images/landing/mentors/cards/신영진.png', mentor_name: '신영진', sort_order: 140, is_active: true },
  { id: 'preview-mentor-15', image_url: '/images/landing/mentors/cards/정재웅.png', mentor_name: '정재웅', sort_order: 150, is_active: true },
  { id: 'preview-mentor-16', image_url: '/images/landing/mentors/cards/성민우.png', mentor_name: '성민우', sort_order: 160, is_active: true },
  { id: 'preview-mentor-17', image_url: '/images/landing/mentors/cards/최정연.png', mentor_name: '최정연', sort_order: 170, is_active: true },
  { id: 'preview-mentor-18', image_url: '/images/landing/mentors/cards/이승현.png', mentor_name: '이승현', sort_order: 180, is_active: true },
  { id: 'preview-mentor-19', image_url: '/images/landing/mentors/cards/한정원.png', mentor_name: '한정원', sort_order: 190, is_active: true },
  { id: 'preview-mentor-20', image_url: '/images/landing/mentors/cards/정채윤.png', mentor_name: '정채윤', sort_order: 200, is_active: true },
  { id: 'preview-mentor-21', image_url: '/images/landing/mentors/cards/함다현.png', mentor_name: '함다현', sort_order: 210, is_active: true },
  { id: 'preview-mentor-22', image_url: '/images/landing/mentors/cards/한혜원.png', mentor_name: '한혜원', sort_order: 220, is_active: true },
];
