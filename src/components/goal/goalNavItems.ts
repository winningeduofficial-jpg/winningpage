...
// QA 행318 — 사이드바 상단 사이트 메인 이동 링크는 제거했다(구 `GOAL_NAV_HEADER`,
// 2026-09-06). 목표관리 앱 셸에 사이트 공통 헤더(Header.tsx)가 새로 붙으면서
// (GoalAppLayout.tsx 참고) 헤더 로고·메뉴가 메인 이동 통로 역할을 대신한다 —
// 수행평가 사이드바(PerformanceSidebar.tsx)가 같은 이유로 상단 "메인으로"·하단
// "메인으로 나가기"를 뺀 것과 동일 결정.
