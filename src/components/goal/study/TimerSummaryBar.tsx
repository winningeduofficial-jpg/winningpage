  ...
  return (
    ...
    >
      ...
      <button
        ...
        disabled={finishing}
        className="flex h-9.75 shrink-0 items-center justify-center rounded-full bg-ink-strong px-6 text-app-body font-semibold leading-[1.2] text-white disabled:opacity-60"
      >
        전체 종료 후 기록
      </button>
    </GoalCard>
