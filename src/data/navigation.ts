...
//
// 2026-09-03 사용자 결정(B안): 신규 헤더 시안(header-footer-figma-2026-09.md §1·§2)이 한때
// nav·메가 컬럼을 160px/10rem 고정폭+clamp(vw)로 통일했었으나, "nav·메가 컬럼 얼라인은
// dev 방식(좌측선 공유)으로 되돌린다"는 결정에 따라 위 dev 정본 값(NAV_CELL_W 6.25rem/
