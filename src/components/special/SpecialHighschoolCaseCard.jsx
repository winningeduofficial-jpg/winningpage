  ...
  return (
    <article className="relative mx-auto aspect-[344/242.38] w-full max-w-[22rem] overflow-hidden bg-[#E9F4FF]">
      ...
      <div
        ...
        style={{ left: '36.2%', right: '18.3%', top: '27.13%', height: '27.77%' }}
      />
      ...
      <div
        ...
        style={{ left: '8.43%', width: '34.7%', top: '22.86%', height: '9.82%' }}
      >
        <span
          className="flex h-full items-center pl-[0.28rem]"
          style={{ fontSize: '0.70625rem', lineHeight: '0.90875rem', color: '#808D9B' }}
        >
          Success Case
        </span>
      </div>
      ...
      >
        ...
        <div className="absolute inset-x-0 px-2 text-center" style={{ top: '18.85%' }}>
          <p style={{ fontSize: '0.70625rem', lineHeight: '0.90875rem', color: '#9FA9B3' }}>
            {metaLine1}
          </p>
          <p style={{ fontSize: '0.70625rem', lineHeight: '0.90875rem', color: '#9FA9B3' }}>
            {metaLine2}
        ...
        <p
          ...
          style={{ fontSize: '1.81875rem', lineHeight: '2.375rem', top: '44.57%' }}
        >
          {row?.school_name}
        </p>
      </div>
