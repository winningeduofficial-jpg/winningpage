...
values
  -- 위닝 목표관리
  ('goal-1m',  'goal', '위닝 목표관리', '단순히 희망 대학을 적는 기능이 아니라, 학생의 현재 성적, 학습 습관, 수행평가 흐름, 학생부 방향을 함께 분석하여 목표 달성 가능성을 높이는 관리 체계입니다.', 1, 1, '[1개월] 위닝 목표관리',  30000,  30000, null,      false),
  ('goal-3m',  'goal', '위닝 목표관리', '단순히 희망 대학을 적는 기능이 아니라, 학생의 현재 성적, 학습 습관, 수행평가 흐름, 학생부 방향을 함께 분석하여 목표 달성 가능성을 높이는 관리 체계입니다.', 1, 2, '[3개월] 위닝 목표관리',  90000,  81000, '10% 할인', false),
  ('goal-6m',  'goal', '위닝 목표관리', '단순히 희망 대학을 적는 기능이 아니라, 학생의 현재 성적, 학습 습관, 수행평가 흐름, 학생부 방향을 함께 분석하여 목표 달성 가능성을 높이는 관리 체계입니다.', 1, 3, '[6개월] 위닝 목표관리', 180000, 144000, '20% 할인', false),
  ('goal-12m', 'goal', '위닝 목표관리', '단순히 희망 대학을 적는 기능이 아니라, 학생의 현재 성적, 학습 습관, 수행평가 흐름, 학생부 방향을 함께 분석하여 목표 달성 가능성을 높이는 관리 체계입니다.', 1, 4, '[12개월] 위닝 목표관리', 360000, 252000, '30% 할인', true),

  -- 위닝 수시예측
  ('susi-1',  'susi', '위닝 수시예측', '학생의 내신, 비교과 흐름, 진로 방향, 희망 대학을 종합해 수시 지원 전략을 설계하는 관리 서비스입니다. 지원 가능성, 보완점, 전형별 준비 방향을 함께 확인할 수 있습니다.', 2, 1, '[1회 이용권] 위닝 수시예측', 30000, 30000, null,       false),
  ('susi-2',  'susi', '위닝 수시예측', '학생의 내신, 비교과 흐름, 진로 방향, 희망 대학을 종합해 수시 지원 전략을 설계하는 관리 서비스입니다. 지원 가능성, 보완점, 전형별 준비 방향을 함께 확인할 수 있습니다.', 2, 2, '[2회 이용권] 위닝 수시예측', 60000, 55000, '약 8% 할인', false),
  ('susi-30', 'susi', '위닝 수시예측', '학생의 내신, 비교과 흐름, 진로 방향, 희망 대학을 종합해 수시 지원 전략을 설계하는 관리 서비스입니다. 지원 가능성, 보완점, 전형별 준비 방향을 함께 확인할 수 있습니다.', 2, 3, '[12개월 30회 이용권] 위닝 수시예측', 90000, 80000, '약 11% 할인', true),
