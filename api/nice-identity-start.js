...
//   NICE는 return_url을 사전 등록 없이 요청마다 자유롭게 받아준다(example.com도
//   localhost도 통과한다 — 2026-08-06 확인). 그래서 클라이언트가 보낸 값을
//   그대로 실으면 인증 결과를 통째로 남의 서버로 보내버릴 수 있다.
//   이 파일은 req.body의 어떤 URL도 쓰지 않는다.
//
// ⚠️ 아직 연결되지 않은 것
