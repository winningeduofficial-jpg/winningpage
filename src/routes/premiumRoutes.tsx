...
// 특목고입학 코드 페이지 + CMS 2종). ⚠️ 반드시 dynamicPageRoutes(/page/:slug)보다 먼저
// 조립한다 — 아래로 내려가면 DynamicPage가 먼저 매칭해 신규 페이지가 뜨지 않는다
// (applyRoutes.tsx:7 동일 규약). 구 /page/premium-* 경로는 코드 라우트·DB 행 모두 없음
// → catch-all에서 자연 404.
