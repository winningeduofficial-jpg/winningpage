...
export const UNIVERSITY_OPTIONS = [
  { name: '서울대학교', departments: ['경영학과', '경제학과', '컴퓨터공학부', '전기정보공학부', '의예과'] },
  { name: '연세대학교', departments: ['경영학과', '심리학과', '전기전자공학부', '언더우드학부'] },
  { name: '고려대학교', departments: ['경영학과', '정치외교학과', '컴퓨터학과', '의과대학'] },
  { name: '성균관대학교', departments: ['글로벌경영학과', '소프트웨어학과', '전자전기공학부'] },
  { name: '한양대학교', departments: ['건축학부', '컴퓨터소프트웨어학부', '경영학부'] },
  { name: '중앙대학교', departments: ['경영학과', '소프트웨어학부', '심리학과'] },
  { name: '경희대학교', departments: ['한의예과', '경영학과', '컴퓨터공학과'] },
  { name: '건국대학교', departments: ['경영학과', '컴퓨터공학부', '수의예과'] },
  { name: '울산대학교', departments: ['의예과', '기계공학부', '경영학부'] },
  { name: '울산과학기술원', departments: ['전기전자공학과', '컴퓨터공학과', '화학공학과'] },
  { name: '울산과학대학교', departments: ['간호학과', '기계공학과', '경영학과'] }
];
...
export const DAILY_SCHEDULE_FIELDS = [
  { key: 'wakeUpHour', label: '기상 시간', unit: '시', min: 0, max: 23, defaultValue: 7 },
  { key: 'sleepHour', label: '취침 시간', unit: '시', min: 0, max: 24, defaultValue: 24 },
  { key: 'schoolStayHours', label: '학교 체류', unit: '시간', min: 0, max: 24, defaultValue: 8 },
  { key: 'academyHours', label: '학원・과외', unit: '시간', min: 0, max: 24, defaultValue: 2 }
];
