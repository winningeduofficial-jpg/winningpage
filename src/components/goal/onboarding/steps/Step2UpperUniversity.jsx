...
export default function Step2UpperUniversity({ goPrev, goNext }) {
  ...
  const canProceed = !!upperUniversity.university && !!upperUniversity.department;
  ...
  return (
    <>
      <QuestionCard
        ...
        description={'학습량 산출의 상한선이자, "이상 목표" 진행률의 기준이 됩니다'}
      >
        <UniversitySelect target="upper" value={upperUniversity} onChange={setUpperUniversity} />
