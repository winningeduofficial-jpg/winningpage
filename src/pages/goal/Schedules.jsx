...
export default function Schedules() {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: 의도적으로 마운트 1회만 — location.state/navigate를 deps에 넣으면 위 replace가 만드는 새 location으로 effect가 다시 돌아 무한 루프가 된다.
  useEffect(() => {
