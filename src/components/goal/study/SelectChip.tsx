...
export default function SelectChip({
  ...
  return (
    <label
      className={`flex h-13 w-fit shrink-0 cursor-pointer items-center justify-center rounded-full border px-5 text-app-body font-medium leading-[1.2] transition-colors ${
        selected
